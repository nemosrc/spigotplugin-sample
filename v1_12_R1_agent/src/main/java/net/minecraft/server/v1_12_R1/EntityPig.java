...
public class EntityPig extends EntityAnimal
{
    ...
    private static final Set<Item> bz;
    private boolean bB;
    private int bC;
    private int bD;
    ...
    static
    {
        bx = DataWatcher.a(EntityPig.class, DataWatcherRegistry.h);
        by = DataWatcher.a(EntityPig.class, DataWatcherRegistry.b);
        bz = Sets.newHashSet(new Item[]{Items.CARROT, Items.POTATO, Items.BEETROOT});
    }
    ...
    public EntityPig(World world)
    {
        ...
        System.out.println("CALL EntityPig Constructor");
    }
    ...
    protected void r()
    {
        ...
        this.goalSelector.a(4, new PathfinderGoalTempt(this, 1.2D, false, bz));
    ...
    {
        if (by.equals(datawatcherobject) && this.world.isClientSide)
        {
            this.bB = true;
            this.bC = 0;
            this.bD = (Integer) this.datawatcher.get(by);
        }
    ...
    {
        return (Boolean) this.datawatcher.get(bx);
    }
    ...
    public void setSaddle(boolean flag)
    {
        if (flag)
        {
            this.datawatcher.set(bx, true);
        } else
        {
            this.datawatcher.set(bx, false);
        }
    ...
    public boolean dm()
    {
        ...
        } else
        {
            ...
            this.getDataWatcher().set(by, this.bD);
            return true;
        }
    }
    ...
    {
        return bz.contains(itemstack.getItem());
    }
